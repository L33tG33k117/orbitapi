          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                price: 'Custom',
                period: 'annual',
                desc: 'Compliance, scale, and the option to run it entirely on your own hardware.',
                features: ['Everything in Pro', 'Self-hosted & air-gapped — your servers, your LLM, no internet', 'Custom AI Power allowance', 'SSO / SAML', 'White-label branding', 'Dedicated SLA (99.9%)', 'Dedicated account manager'],
                cta: 'Talk to sales',
