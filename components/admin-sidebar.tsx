...
import {
  ...
  Plug, Flag, BarChart2, Ban, FlaskConical, MessageSquarePlus, X, Bug, Inbox, Server, Megaphone } from 'lucide-react'
...
const items = [
  ...
  { href: '/admin/releases',            label: 'Releases',   icon: Megaphone },
